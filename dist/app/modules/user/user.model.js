...
userSchema.statics.isUserExistsByUsername = function (username) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield exports.User.findOne({ username }).select('+password +passwordHistory');
    });
};
userSchema.statics.isPasswordMatched = function (plainTextPass, hashedPass) {
    return __awaiter(this, void 0, void 0, function* () {
        const isMatched = yield bcrypt_1.default.compare(plainTextPass, hashedPass);
        return isMatched;
    });
};
userSchema.statics.isJWTIssuedBeforePasswordChanged = function (passwordChangedTimestamp, jwtIssuedTimestamp) {
    const passwordChangedTimes = new Date(passwordChangedTimestamp).getTime() / 1000;
